...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	return ((CaloriesWeightMultiplier * float64(w.Weight) + ((math.Pow(w.meanSpeed() * KmHInMsec, 2))/w.Height) * CaloriesSpeedHeightMultiplier * float64(w.Weight)) *
    w.Duration.Hours() * float64(MinInHours))
}
...
func (s Swimming) Calories() float64 {
	// вставьте ваш код ниже
	return (s.meanSpeed() + SwimmingCaloriesMeanSpeedShift) * float64(SwimmingCaloriesWeightMultiplier) * float64(s.Weight) * float64(s.Duration.Hours())
}
